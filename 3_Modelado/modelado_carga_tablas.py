...
populate_table(platform, session, Platform)    
populate_table(rating, session, Rating)    
populate_table(show, session, Show)    
populate_table(country, session, Country)    
populate_table(show_for_country, session, Show_for_country)    
populate_table(actor, session, Actor)    
populate_table(show_for_actor, session, Show_for_actor)    
populate_table(director, session, Director)    
populate_table(show_for_director, session, Show_for_director)    
populate_table(genre, session, Genre)    
populate_table(show_for_genre, session, Show_for_genre) 